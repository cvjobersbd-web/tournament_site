...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ডেমো লজিক (প্রোডাকশনে এপিআই কল যোগ করুন)
    ...
    <div style={{
      ...
      <div className="login-card" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          }}>Sign in to continue your gaming journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{
            ...
            }} onMouseEnter={e => e.currentTarget.style.color = '#ff9800'} onMouseLeave={e => e.currentTarget.style.color = '#a855f7'}>
              Forgot Password?
            </Link>
          </div>
